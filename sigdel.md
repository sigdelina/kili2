...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: В документе слово может встречаться несколько раз.
```
...
```
# 3.4 Ответ: словосочетния в их полной форме возможно искать только с помощью точного поиска, так как в поле "Слово" можно искать только словоформы, а для конкретных фраз поиск осущетсвляется в "Поиск точных форм"
```
